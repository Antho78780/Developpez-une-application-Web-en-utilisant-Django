...
class UserFollows(models.Model):
    user = models.ForeignKey(to=settings.AUTH_USER.MODEL, on_delete=models.CASCADE, related_name='following')
    followed_user = models.ForeignKey(to=settings.AUTH.USER.MODEL, on_delete=models.CASCADE, related_name='followed_by')
